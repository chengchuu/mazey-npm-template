...
function transformApiHtml(html, relativeFile) {
  ...
  const metadata = `<title>${escapeAttribute(title)}</title>${[
    ...
    `<style>:root{--project-theme-primary:${theme.colorPrimary};--project-theme-primary-hover:${theme.primary.light.hover};--project-theme-primary-active:${theme.primary.light.active};--project-theme-primary-soft:${theme.primary.light.soft};--project-theme-primary-rgb:${theme.primary.light.rgb};--project-theme-primary-hover-rgb:${theme.primary.light.hoverRgb};--project-theme-primary-active-rgb:${theme.primary.light.activeRgb};--project-theme-primary-dark:${theme.primary.dark.base};--project-theme-primary-dark-hover:${theme.primary.dark.hover};--project-theme-primary-dark-active:${theme.primary.dark.active};--project-theme-primary-dark-soft:${theme.primary.dark.soft};--project-theme-primary-dark-rgb:${theme.primary.dark.rgb};--project-theme-primary-dark-hover-rgb:${theme.primary.dark.hoverRgb};--project-theme-primary-dark-active-rgb:${theme.primary.dark.activeRgb};--project-theme-light:${theme.colorLight};--project-theme-dark:${theme.colorDark}}</style>`,
...
function writePwaAssets(rootDir, docs) {
  ...
  for (const asset of apiAssets) {
    ...
    try {
      ...
      throw new Error(`API app-shell asset has invalid encoding: ${asset}`);
    }
    ...
    if (
      ...
      throw new Error(`API app-shell asset leaves Pages output: ${asset}`);
